...
- **Filtrage** et extraction des seuls noms de domaine purs. Les règles cosmétiques, les modificateurs AdBlock, les URLs avec chemin sont écartés car non interprétables au niveau DNS ainsi que les adresses IP
